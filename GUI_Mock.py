...
#        self.textLabel.move(20,0)
        ...
        self.secretLabel = QLabel(self)
        self.secretLabel.setText("Password For Encryption: ")

        # Create Textbox for File Retirieve
        self.retrieveFileLabel = QLabel(self)
        self.retrieveFileLabel.setText("Name of the File to Retrieve from Cloud: ")
        self.retrieveFileName = QLineEdit(self)
...
#        self.remoteFiles.move(20,50)
        ...
        self.button3.clicked.connect(self.on_clickRetrieve)

        self.button4.clicked.connect(self.on_click2)

        hbox0 = QHBoxLayout()
        hbox0.addWidget(self.secretLabel)
        hbox0.addWidget(self.secretInput)
        ...
        hbox3 = QHBoxLayout()
        hbox.addStretch(1)
        hbox3.addWidget(self.retrieveFileLabel)
        hbox3.addWidget(self.retrieveFileName)
